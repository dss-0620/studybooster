    ...
    <header>
            <div class="container-fluid px-0">
                    ...
                    <div class="col-md-2 mt-3">
                            ...
                            <div class="row pl-3 my-3 link-type1"><a href="../notes"><i class="fas fa-book-open mr-2"></i>Notes</a></div>
                            <div class="row pl-3 my-3 link-type1"><a href="../add_content"><i class="fas fa-plus mr-2"></i>Add Content</a></div>
