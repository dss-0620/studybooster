...
<body>
            ...
            <div class="container-fluid px-0">
                    ...
                    <!--After submit button clicked-->
                        ...
                        <div class="row ml-2 mt-3 ml-md-5 mt-md-5">
                            <div class="col-10" style="font-weight:450;">
                                Congratulations!
                            </div>
                        </div>
                        <div class="row ml-2 ml-md-5 mt-2" style="font-weight:400;">
                            <div class="col-10">
                        ...
                        <div class="row mx-2 mx-md-5 mt-3 p-2" style="font-weight:370; font-size:85%; border:1px solid black;">
                            <div class="col-11">
                        ...
                        <div class="row ml-2 ml-md-5 mt-3" style="font-weight:400;">
                            <div class="col-10">
                                <a href="../add_result" class="btn btn-primary">CREATE NEW RESULT</a>
                            </div>
                        </div>
                        <?php
                                }
                                 ...
                                 //  echo $sbcount;
                                    ...
                                    {  
                                            ...
                                            if($sbcmp[$i]->getSubcomponents_name() == 'Class Test'){
                                                ...
                                                <input type='number' class='form-control {$sbcmp[$i]->getSubcomponents_name()} d-inline-block' style='display:inline-block;' placeholder='Enter marks (out of 30)' id='input-1' name='{$sub_comp_counter}' max='30'><div>";
                                            }
                                            if($sbcmp[$i]->getSubcomponents_name() == 'Sessional Exam'){
                                                echo "<div class='form-group my-2'><label for='input-1' class='disp2 my-1 ml-md-1'>{$sbcmp[$i]->getSubcomponents_name()}</label>
                                                <input type='number' class='form-control {$sbcmp[$i]->getSubcomponents_name()} d-inline-block' style='display:inline-block;' placeholder='Enter marks (out of 40)' id='input-1' name='{$sub_comp_counter}' max='40'><div>";
                                            }
                                            ...
                                            if($sbcmp[$i]->getSubcomponents_name() == 'Term Assignment'){
                                                echo "<div class='form-group my-2'><label for='input-1' class='disp2 my-1 ml-md-1'>{$sbcmp[$i]->getSubcomponents_name()}</label>
                                                <input type='number' class='form-control {$sbcmp[$i]->getSubcomponents_name()} d-inline-block' style='display:inline-block;' placeholder='Enter marks (out of 60)' id='input-1' name='{$sub_comp_counter}' max='60'><div>";
                                            }
                                            if($sbcmp[$i]->getSubcomponents_name() == 'Lab File'){
                                                echo "<div class='form-group my-2'><label for='input-1' class='disp2 my-1 ml-md-1'>{$sbcmp[$i]->getSubcomponents_name()}</label>
                                                <input type='number' class='form-control {$sbcmp[$i]->getSubcomponents_name()} d-inline-block' style='display:inline-block;' placeholder='Enter marks (out of 75)' id='input-1' name='{$sub_comp_counter}' max='75'><div>";
                                            }
                                            if($sbcmp[$i]->getSubcomponents_name() == 'Viva'){
                                                echo "<div class='form-group my-2'><label for='input-1' class='disp2 my-1 ml-md-1'>{$sbcmp[$i]->getSubcomponents_name()}</label>
                                                <input type='number' class='form-control {$sbcmp[$i]->getSubcomponents_name()} d-inline-block' style='display:inline-block;' placeholder='Enter marks (out of 25)' id='input-1' name='{$sub_comp_counter}' max='25'><div>";
                                            }
                                            if($sbcmp[$i]->getSubcomponents_name() == 'SEE'){
                                                echo "<div class='form-group my-2'><label for='input-1' class='disp2 my-1 ml-md-1'>{$sbcmp[$i]->getSubcomponents_name()}</label>
                                                <input type='number' class='form-control {$sbcmp[$i]->getSubcomponents_name()} d-inline-block' style='display:inline-block;' placeholder='Enter marks (out of 100)' id='input-1' name='{$sub_comp_counter}' max='100'><div>";
                                            }
                                         $sub_comp_counter++;
                                    }
                                //    $a++;
    ...
    <?php 
        if(isset($_POST['submit']) && ($_SESSION['storage'] < 10))
        {   
