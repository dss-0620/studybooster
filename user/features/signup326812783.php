...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col col-xs-10 col-sm-9 col-md-7 col-lg-5 signup">
                    <form action="signup.php" method="POST" class="form-group form1">
                        ...
                        <div class="form-group">
                         <input type="text" class="form-control" placeholder="First Name (required)" name="FirstName" required>   
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Last Name (optional)" name="LastName">   
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="E-mail (required)" name="Username" required>   
                        </div>
                        <div class="form-group">
                     ...
                     <?php
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control passwo" placeholder="Password (required)" name="Password" required>   
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control conpasswo" placeholder="Confirm Password (required)" name="ConfirmPassword" required>   
                        </div>
                        <div class="form-group">
    ...
    *{
    ...
    <?php 
        function signup($user_firstname,$user_lastname,$username,$user_password,$user_semester_id,$user_group_id,$user_branch_id,$user_college_id){
            global $connection;
            $query="INSERT INTO users(user_firstname,user_lastname,username,user_password,user_semester_id,user_group,user_branch_id,user_college_id) ";
            $query.="VALUES ('$user_firstname','$user_lastname','$username','$user_password',$user_semester_id,$user_group_id,$user_branch_id,$user_college_id) ";
            $result=mysqli_query($connection,$query);
            check_query($result);
        }
    ?>
  <?php 
    if(isset($_POST['submit']))
    {
        ...
        if(empty($user_college_id))
        ...
        else if((empty($user_group_id) && ($user_semester_id == 1 || $user_semester_id == 2)))
            ...
            signup($user_firstname,$user_lastname,$username,$user_password,$user_semester_id,$user_group_id,$user_branch_id,$user_college_id);
            //include "email.php";
            ?>
            <form action="../../php/login.php" name="form" method="POST">
                <input type="email" value="<?php echo $username; ?>" name="username" hidden>
        ...
        if(isset($_GET['password']))
        {
            ...
            echo "<script>
                    document.querySelector('.wrong1').textContent = 'Your password do not match';   
