    ...
    <?php if(!(isset($_GET['rs']) && isset($_GET['sub']))){ ?>
                <div class="row d-flex justify-content-end mb-3">
                    ...
                    <form action="../delete_all_results.php" method="post">
                        ...
                        <input type="submit" class="btn btn-danger" value="DELETE ALL RESULTS">
                    </form>
                    </div>
                </div>
    <?php } ?>
                    ...
                    <?php if(!(isset($_GET['rs']) && isset($_GET['sub']))){ ?>
                        <table class="table table-bordered table-hover">
                            <thead>
                                ...
                                <?php 
                                    ...
                                    for($i=0;$i<($result_array[0]->getSubject_count());$i++){
                                       echo "<th>{$arr[$i]->getSubject_name()}</th>";
                                    }
                                ?>
                                <th>S.P.I.</th>
                                <th></th>
                           ...
                           for($j=0;$j<$count;$j++){
                            ...
                            echo "<td>$ptr</td>";
                            echo "<td><form action='../delete_result.php' method='post'><input type='text' name='result_id' value='{$result_array[$j]->getResult_id()}' hidden><input type='submit' value='Delete' class='btn btn-outline-danger' name='delete'></form></td>";
                            echo "</tr>"; 
                                }
                            ?>
                            </tbody>
                        </table>
                        <div class="row mx-2 mx-md-5 mt-5 p-2" style="font-weight:350; font-size:110%; border:1px solid black;">
