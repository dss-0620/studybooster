            ...
            <div class="container-fluid px-0">
                            ...
                            <div class="dropdown">
                              <a href="#" class="nav-item nav-link dropdown-toggle" id="user" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon ion-md-person mr-1"></i><?php echo $_SESSION['firstname'];?></a>
                               <div class="dropdown-menu" aria-labelledby="user">
                                  <a href="php/profile" class="dropdown-item">Profile</a>
                ...
                <div class="row pt-4 main-cont-space1">
                    <div class="col-md-2 mt-3 main-menu1 js--main-menu1">
                            ...
                            <div class="row pl-3 my-3 link-type1"><a href="php/add_result"><i class="far fa-plus-square mr-2"></i>Create new result</a></div>
                            <div class="row pl-3 my-3 link-type1"><a href="php/grade_result"><i class="fas fa-calculator mr-2"></i>Grade result</a></div>
                            <div class="row pl-3 my-3 link-type1"><a href="php/view_saved_results"><i class="fas fa-binoculars mr-2"></i>View saved results</a></div>
                            <div class="row pl-3 my-3 link-type1"><a href="php/view_all_users"><i class="far fa-eye mr-2"></i>View all user</a></div>
                            <div class="row pl-3 my-3 link-type1"><a href="php/change_password"><i class="far fa-edit mr-2"></i>Change Password</a></div>
                            <div class="row pl-3 my-3 link-type1"><a href="php/feedback"><i class="far fa-comments mr-2"></i>Give feedback</a></div>
                    </div>
                       ...
                       ?>
                        <div class="row">
                            <div class="col d-flex justify-content-center mt-5" style="font-weight:400; font-size:18px; color:#6e6e6e;">
                                <a href="php/add_result">Create new result</a> &nbsp;to display graph based on your performance
                            </div>
                        </div>
