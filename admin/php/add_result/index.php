                            ...
                            <div class="dropdown">
                              <a href="#" class="nav-item nav-link dropdown-toggle" id="user" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon ion-md-person mr-1"></i><?php echo $_SESSION['firstname'];?></a>
                               <div class="dropdown-menu" aria-labelledby="user">
                                  ...
                                  <a href="../../../user/features/logout.php" class="dropdown-item">Log Out</a>
                               </div>  
                            </div>
                        </div>
                    </div>
                    ...
                    <!--After submit button clicked-->
                        ...
                        <form action="" method="post" class="col-xs-9 col-sm-8 col-md-7 col-lg-6 col-xl-5 ml-md-4 mt-md-4 form-group">
                           ...
                           <div class="form-group">
                                <input type="submit" name="submit" value = "Calculate" class="form-control btn btn-primary submit-check1 mt-4 mb-4">
                           </div>
                        </form>
                        </div>
                    </div>
